...
// va implementato un modo per cui il compilatore prenda il file dalla BUILD
    ...
    inline std::array<std::string, 30> tilePaths { 
        ...
        "../../assets/png_PROGETTO/gifs/PENDULUM_spritesheet.png",              //14
        ...
        "../../assets/png_PROGETTO/text/STOP_text_spritesheet.png",             //26
        "../../assets/png_PROGETTO/text/WALL_text_spritesheet.png",             //27
        "../../assets/png_PROGETTO/text/WIN_text_spritesheet.png",              //28
        "../../assets/png_PROGETTO/text/YOU_text_spritesheet.png"               //29
    };
